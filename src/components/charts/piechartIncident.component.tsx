...
import { useIncidentsBySeverity } from "../../services/healthServices/health.query"

interface SeverityPieChartProps {
  filters?: any 
}

export default function SeverityPieChart({ filters }: SeverityPieChartProps) {
  const { data, isLoading, error } = useIncidentsBySeverity(filters)
  ...
  const options: ApexOptions = {
    ...
    tooltip: {
      y: {
        formatter: (val: number) => `${val} incident(s)`,
      },
    },
  }
